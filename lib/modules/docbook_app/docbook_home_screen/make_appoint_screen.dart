...
class _BookingPageState extends State<BookingPage> {
  ...
  DateTime _focusDay=DateTime.now().add(Duration(days: 1));
  DateTime _currentDay=DateTime.now().add(Duration(days: 1));
  String? chosenTime;
  int? _currentIndex;
  ...
  List<String> timeList = ["12:00 PM","01:00 PM","02:00 PM","03:00 PM","04:00 PM","05:00 PM","06:00 PM","07:00 PM",];
  @override
                        ...
                        return   InkWell(
                          ...
                          onTap: (){
                            setState(() {
                              _currentIndex=index;
                              _timeSelected=true;
                              chosenTime=(_currentIndex!+12).toString();
                            });
                          },
                          child:Container(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: _timeSelected && _dateSelected? (){
                            /*int index=0;
                            if(chosenTime==DocLoginCubit.get(context).docAppointment[index].start){
