...
import 'package:ramdan_proj/modules/basics_app/login/loginscreen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<DocLoginCubit,DocLoginStates>(
      listener: (BuildContext context, state) {
        if(state is DocBookUpdatePasswordSuccessState)
                        ...
                        InkWell(
                          onTap: (){
                            if(formKey.currentState!.validate()){
                              DocLoginCubit.get(context).updateUserPassword(
                                id: userid,
